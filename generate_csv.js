...
const headers = ['name', 'description', 'imageUrl', 'tags', 'instagram', 'youtube', 'linkedin', 'link', 'whatsapp', 'meetup', 'nivel', 'pontuacao', 'linkCupom'];
...
for (const com of comunidadesBase) {
...
fs.writeFileSync('/home/jgt/Documents/community/agilebrazil-site-2026/comunidades.csv', csvContent);
